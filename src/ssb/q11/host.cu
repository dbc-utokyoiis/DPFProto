...
BenchmarkResult hostSyncSSBQ11(BenchmarkOptions &options)
{
    std::vector<int> fds;
    ...
    std::vector<HostSyncQ11Args> thread_args_vec;
    ...
    for (size_t i = 0; i < nthreads; i++)
    {
        ...
        thread_args_vec.push_back(HostSyncQ11Args{
            .thrid = i,
            .fds = fds,
            .ctx = {},
    ...
    for (size_t i = 0; i < nthreads; i++)
    {
        HostSyncQ11Args &args = thread_args_vec[i];
